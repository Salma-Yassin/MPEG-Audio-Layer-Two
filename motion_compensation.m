...
[out_jpeg, R, C, R_img,C_img] = encode_jpeg(I, qtable); % still using MATLAB huffman though ----> need to be replaced 
I_recon = decode_jpeg(out_jpeg, R, C, R_img,C_img, qtable);
